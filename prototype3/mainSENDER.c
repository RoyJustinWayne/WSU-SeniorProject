	...
	//Naim + Justin 10/11/2018
	enum sf_t { SF7=7, SF8, SF9, SF10, SF11, SF12 = 12};
	...
	int checkifnewer(const char *path, const struct stat *sb, int typeflag)
{
	...
	int main (int argc, char *argv[]) {
		...
		//Naim + Justin 10/11/2018 Creating Sender Only and Receiver only executables.
		/*if (argc < 2) {
