...
class StationCard extends Component {
    ...
    renderWeatherData(){
        ...
        if(this.props.station.station_name === "Master" || this.props.station.station_name === "master")
        {
        ...
        return (
            <div className="col-md-10 col-sm-12">
                <p className="station-info">CPU Usage: <font color={cpuColor}>{cpu_usage} % </font></p>
                <p className="station-info">RAM Usage: <font color={ramColor}>{ram_usage} %</font></p>
                    ...
                    <ModalBody>
                        ...
                        <div className="station-detail-container">
                            <div className="station-detail-row">
                                ...
                                <span className="right"><font color={cpuColor}>{cpu_usage} %</font></span>
                            </div><br/>
                            <div className="station-detail-row">
                                <span className="left">RAM Usage</span>
                                <span className="right"><font color={ramColor}>{ram_usage} %</font></span>
                            </div><br/>
                            <div className="station-detail-row">
