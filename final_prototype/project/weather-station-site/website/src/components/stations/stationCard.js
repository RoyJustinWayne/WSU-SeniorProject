...
class StationCard extends Component {
    ...
    renderWeatherData(){
        ...
        if (temperature > 84.9){
            temperatureClass = "station-info-high";
        }
        else if (temperature < 30){
            temperatureClass = "station-info-low";
        }
        else{
            temperatureClass = "station-info";
        }
        
        return (
            <div className="col-md-6 col-sm-12">
                <p className={temperatureClass}>temperature: {temperature} &deg;F</p>
