...
#The below commented code is the way previous semester posted to the server. We no longer need that because each individual Pi will not be posting anymore, and only Master will post. 
