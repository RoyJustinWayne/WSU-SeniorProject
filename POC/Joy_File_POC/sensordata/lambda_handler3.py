...
def do_work(line):
    ...
    query = "INSERT INTO "+tableName+" (created_at, temperature, humidity, pressure, latitude, longitude, apikey) VALUES ("+"'"+date+"','"+temp+"','"+humidity+"','"+pressure+"','"+latitude+"','"+longitude+"','"+api+"')"
    db(query)
    # with conn.cursor() as cur:
    #     print(query)
    #     cur.execute(query)
